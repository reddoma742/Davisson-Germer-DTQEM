...
| المستودع | README |
|:---|:---|
| **المستودع الرئيسي** (`Davisson-Germer-DTQEM`) | الملف الشامل الذي أرسلته — يصف كل النماذج |
| **مستودع Paper I** (`Paper_I_DTQEM`) | الملف المبسط أعلاه — يركز على هذه الورقة فقط |

**هل تريد مني أي تعديل على README المبسط؟**
